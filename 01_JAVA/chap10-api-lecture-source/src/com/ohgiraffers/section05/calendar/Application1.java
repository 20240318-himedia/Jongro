...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* getTime() : 1970년 1월 1일 0이 0분 0초를 지난 시간을 millisecond로 계산해서 long타입으로 반환한다. */

        System.out.println("today.getTime() = " + today.getTime()); //1712127100182
        
        Date time = new Date(1712127100182L);
